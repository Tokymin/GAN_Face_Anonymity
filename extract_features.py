...
def main():
    ...
    if args.no_clip and args.no_farl and args.no_dino and args.no_arcface:
        print("#. All required features have already been calculated and storead under {}.".format(out_dir))
        return
    ...
    ####################################################################################################################
        ...
        dataset_root="/mnt/disk1/toky/Dataset/CelebA-HQ/CelebAMask-HQ"
        dataset = CelebAHQ(root_dir=dataset_root, subset='train+val+test')
